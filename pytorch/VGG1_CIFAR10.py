...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1=nn.Conv2d(3,16,3,padding=(1,1))#输入通道数 输出通道数 卷积核大小
        self.conv2=nn.Conv2d(16,16,3,padding=(1,1))#输入通道数 输出通道数 卷积核大小
    ...
    def forward(self,x):
        ...
        x=x.view(-1,64*4*4)#类似于numpy里的reshape
